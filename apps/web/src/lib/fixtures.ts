...
export const auditEvents: AuditEvent[] = [
  { schemaVersion: '1.1', eventId: 'audit-consent-001', simulationId, applicantId: applicant.applicantId, eventType: 'consent', occurredAt: '2026-08-07T10:00:00.000Z', modelVersion: null, featureRegistryVersion: null, consentIds: ['consent-baseline-001', 'consent-cashflow-001'], provenanceRefs: ['fixture-applicant-001', 'fixture-cashflow-001'], detail: { action: 'granted', purposeCount: 2 } },
  { schemaVersion: '1.1', eventId: 'audit-score-001', simulationId, applicantId: applicant.applicantId, eventType: 'score', occurredAt: '2026-08-07T10:01:00.000Z', modelVersion: 'scorecard-v1', featureRegistryVersion: 'feature-registry-v1', consentIds: ['consent-baseline-001', 'consent-cashflow-001'], provenanceRefs: ['fixture-applicant-001', 'fixture-cashflow-001'], detail: { dynamicScore: 86, riskBand: 'strong' } },
];
